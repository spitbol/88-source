...
/
/ 1.05  Create version for OS/2.  At this time, the child process
/		inherits _all_ of SPITBOL's open files.  There does not appear
/		to be a way to just give the child process our files 0, 1, and 2.
/
...
#include <os2.h>
extern int spawnl(ULONG mode, char *path, char *arg0, char *arg1, char *arg2);
#else
typedef int HFILE;
#endif
